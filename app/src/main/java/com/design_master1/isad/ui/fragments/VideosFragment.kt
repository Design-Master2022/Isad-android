...
import com.design_master1.isad.databinding.FragmentVideosBinding
...
class VideosFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        mBinding = FragmentVideosBinding.inflate(layoutInflater)
...
//                Log.d(TAG, "onExternalPageRequest: $url")
        ...
        mBinding.webview.loadUrl(mMainActivityViewModel.videoUrl)
